...
//import { getRelatedVideos } from "../../store/actions/videoAction";
...
const WatchPage = () => {
  ...
  const largeScreen = useWindowSize(990);
  const dispatch = useDispatch();

  // const v = {
  //   kind: "youtube#video",
  //   etag: "5YbiX076bR5ejzUK4wf57yY0SoA",
  //   id: "Nvg_-BX8iy4",
  //   snippet: {
  //     publishedAt: "2023-04-22T14:29:48Z",
  //     channelId: "UC4-CH0epzZpD_ARhxCx6LaQ",
  //     title: "OUR FIRST NIGHT IN OUR NEW HOUSE",
  //     description:
  //       "watch the new COLE AND EV video here! https://www.youtube.com/watch?v=zpUrImiQMRA",
  //     thumbnails: {
  //       default: {
  //         url: "https://i.ytimg.com/vi/Nvg_-BX8iy4/default.jpg",
  //         width: 120,
  //         height: 90,
  //       },
  //       medium: {
  //         url: "https://i.ytimg.com/vi/Nvg_-BX8iy4/mqdefault.jpg",
  //         width: 320,
  //         height: 180,
  //       },
  //       high: {
  //         url: "https://i.ytimg.com/vi/Nvg_-BX8iy4/hqdefault.jpg",
  //         width: 480,
  //         height: 360,
  //       },
  //       standard: {
  //         url: "https://i.ytimg.com/vi/Nvg_-BX8iy4/sddefault.jpg",
  //         width: 640,
  //         height: 480,
  //       },
  //       maxres: {
  //         url: "https://i.ytimg.com/vi/Nvg_-BX8iy4/maxresdefault.jpg",
  //         width: 1280,
  //         height: 720,
  //       },
  //     },
  //     channelTitle: "The LaBrant Fam",
  //     tags: [
  //       "cole and sav",
  //       "the labrant fam",
  //       "labrant fam",
  ...
  const moreVideos = (type = "button") => {
    if (type == "scroll" && !largeScreen) {
      return;
    }
    nextVideos();
  };
  ...
  return (
    <>
      <Row className="d-lg-block">
        ...
        <Col lg={8} md={12} className="float-start">
        ...
        <Col lg={4} md={12} className="relatedVideos float-end">
          {videos.length ? (
            <>
              <div>
                <InfiniteScroll
                  dataLength={videos.length}
                  next={moreVideos("scroll")}
                  hasMore={true}
                  loader={
                    largeScreen && (
            ...
            <div className="relatedVideos">
              <SkeletonTheme color="#343a40" highlightColor="#3c4147">
                <Skeleton width="60%" height="130px" count={15} />
              </SkeletonTheme>
            </div>
          )}
          {!largeScreen & videos.length ? (
            <div className="relatedVideos__show_more_videos">
              <button
                classname="show_more"
                onClick={moreVideos}
